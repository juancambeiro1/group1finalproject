...
plot1 <- ggplot(data.frame(t = t, actual_infected = actual_infected, I = I, D = D, A = A, R = R, T = T, H = H, E = E, diagnosed_H = diagnosed_H), aes(t)) +
  ...
  labs(x = "Time (days)", y = "Cases (fraction of the population)", title = "2a: Short-term evolution: actual vs diagnosed cases of infection") +
...
plot2 <- ggplot(data.frame(t = t, I = I, D = D, A = A, R = R, T = T), aes(t)) +
  ...
  labs(x = "Time (days)", y = "Cases (fraction of the population)", title = "2b: Short-term evolution of infected subpopulations") +
...
plot3 <- ggplot(data.frame(t = t, actual_infected = actual_infected, I = I, D = D, A = A, R = R, T = T, H = H, E = E, diagnosed_H = diagnosed_H), aes(t)) +
  ...
  geom_line(aes(y = D + R + T), color = "red", linetype = "dotted") +
  geom_line(aes(y = diagnosed_H), color = "green", linetype = "dotted") +
  labs(x = "Time (days)", y = "Cases (fraction of the population)", title = "2c: Long-term evolution: actual vs diagnosed cases of infection") +
...
plot4 <- ggplot(data.frame(t = t, I = I, D = D, A = A, R = R, T = T), aes(t)) +
  ...
  geom_line(aes(y = R), color = "magenta") +
  geom_line(aes(y = T), color = "red") +
  labs(x = "Time (days)", y = "Cases (fraction of the population)", title = "2d: Long-term evolution of infected subpopulations") +
      scale_x_continuous(limits = c(min(t), max(t)), breaks = seq(50,350, by = 50)) +
  scale_y_continuous(limits = c(0, 1.1e-3)) +
  theme_minimal()
...
plot5 <- ggplot(df, aes(x = t)) +
  ...
  geom_line(aes(y = D + R + T), color = "red", linetype = "dotted") +
  geom_line(aes(y = diagnosed_H), color = "green", linetype = "dotted") +
  labs(title = "3a: Predicted epidemic evolution: actual vs diagnosed cases of infection (weakened lockdown)", x = "Time (days)", y = "Cases (fraction of the population)") +
...
plot6 <- ggplot(df, aes(x = t)) +
  ...
  geom_line(aes(y = R), color = "magenta") +
  geom_line(aes(y = T), color = "red") +
  labs(x = "Time (days)", y = "Cases (fraction of the population)", title = "3b: Predicted evolution of infected subpopulations (weakened lockdown)") +
  scale_y_continuous(limits = c(0, 1.1e-3)) +
  scale_x_continuous(limits = c(min(t), max(t)), breaks = seq(50, 350, by = 50)) +
  theme_minimal()
...
plot7 <- ggplot(data, aes(t)) +
  ...
  geom_line(aes(y = D + R + T), color = "red", linetype = "dotted") +
  geom_line(aes(y = diagnosed_H), color = "green", linetype = "dotted") +
  labs(x = "Time (days)", y = "Cases (fraction of the population)", title = "3c: Predicted epidemic evolution: actual vs diagnosed cases of infection (strengthened lockdown)") +
    scale_x_continuous(limits = c(min(t), max(t)), breaks = seq(50,350, by = 50)) +
  scale_y_continuous(limits = c(0, 0.015)) +
  theme_minimal()
...
plot8 <- ggplot(data, aes(t)) +
  ...
  geom_line(aes(y = R), color = "magenta") +
  geom_line(aes(y = T), color = "red") +
  labs(x = "Time (days)", y = "Cases (fraction of the population)", title = "3d: Predicted evolution of infected subpopulations (strengthened lockdown)") +
...
plot9 <- ggplot(data, aes(t)) +
  ...
  geom_line(aes(y = D + R + T), color = "red", linetype = "dotted") +
  geom_line(aes(y = diagnosed_H), color = "green", linetype = "dotted") +
  labs(x = "Time (days)", y = "Cases (fraction of the population)", title = "4a: Predicted epidemic evolution: actual vs diagnosed cases of infection (widespread testing)") +
  scale_x_continuous(limits = c(min(t), max(t)), breaks = c(50, 100, 150, 200, 250, 300, 350)) +
  ylim(0, 0.015) +
  theme_minimal()
...
plot10 <- ggplot(df, aes(x = t)) +
  ...
  geom_line(aes(y = R), color = "magenta") +
  geom_line(aes(y = T), color = "red") +
  labs(title = "4b: Predicted evolution of infected subpopulations (widespread testing)", x = "Time (days)", y = "Cases (fraction of the population)") +
  scale_y_continuous(limits = c(0, 1.1e-3)) +
...
plot11 <- ggplot(data, aes(t)) +
  ...
  geom_line(aes(y = D + R + T), color = "red", linetype = "dotted") +
  geom_line(aes(y = diagnosed_H), color = "green", linetype = "dotted") +
  labs(x = "Time (days)", y = "Cases (fraction of the population)", title = "4c: Predicted epidemic evolution: actual vs diagnosed cases of infection (widespread testing & weakened lockdown)") +
  scale_x_continuous(limits = c(min(t), 350), breaks = seq(50, 350, by = 50)) +
  scale_y_continuous(limits = c(0, 0.015)) +
  theme_minimal()
...
plot12 <- ggplot(data, aes(t)) +
  ...
  geom_line(aes(y = R), color = "magenta") +
  geom_line(aes(y = T), color = "red") +
  labs(x = "Time (days)", y = "Cases (fraction of the population)", title = "4d: Predicted evolution of infected subpopulations (widespread testing & weakened lockdown)") +
  scale_x_continuous(breaks = seq(50, 350, by = 50)) +
    ylim(0, 1.1e-3) +
  theme_minimal()
...
ggsave("fig4d.pdf", plot = plot12, width = 24, height = 16, units = "cm")
